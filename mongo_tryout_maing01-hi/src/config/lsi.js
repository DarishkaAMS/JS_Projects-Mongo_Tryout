const Lsi = {
  appName: {
    cs: "Aplikace mongoTryout",
    en: "Application mongoTryout",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci mongoTryout",
      en: "About application mongoTryout",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní mongoTryout.",
      en: "You can buy your own mongoTryout.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci mongoTryout.",
      en: "You don't have rights to initialize this mongoTryout.",
    },
  },
